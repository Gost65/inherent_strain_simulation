...
Original file is located at
    https://colab.research.google.com/drive/16BBOzDI5mIlWG-WLGyyMlWyVycS9XEML
...
# **1-Importations and installations**

###In this section we install:
 - [meshio](https://colab.research.google.com/drive/16BBOzDI5mIlWG-WLGyyMlWyVycS9XEML#scrollTo=PCUlyMG9bgxJ&line=3&uniqifier=1)
 - [vtk](https://colab.research.google.com/drive/16BBOzDI5mIlWG-WLGyyMlWyVycS9XEML#scrollTo=8wEJhjWpe0wK&line=4&uniqifier=1)
 - [FEniCS (dolfin)](https://colab.research.google.com/drive/16BBOzDI5mIlWG-WLGyyMlWyVycS9XEML#scrollTo=ZhrJA363Fulb&line=5&uniqifier=1)


###We import:
 - [os and sys](https://colab.research.google.com/drive/16BBOzDI5mIlWG-WLGyyMlWyVycS9XEML#scrollTo=YZ49xWo4hADm&line=1&uniqifier=1)
"""
